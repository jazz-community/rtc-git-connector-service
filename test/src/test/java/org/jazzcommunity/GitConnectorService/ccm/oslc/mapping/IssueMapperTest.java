...
import org.jazzcommunity.GitConnectorService.olsc.type.issue.GitCmAssignee;
import org.jazzcommunity.GitConnectorService.olsc.type.issue.GitCmAssignee_;
...
import org.jazzcommunity.GitConnectorService.olsc.type.issue.GitCmMilestone;
...
public class IssueMapperTest {
  ...
  public void checkAssigneeMapping() {
    ...
    Assert.assertTrue(EqualsBuilder.reflectionEquals(expected, assignee));
  }
  ...
  public void checkMilestoneMapping() {
    ...
    Assert.assertTrue(EqualsBuilder.reflectionEquals(expected, oslcIssue.getGitCmMilestone()));
  }
  ...
  public void checkAuthorMapping() {
    ...
    Assert.assertTrue(EqualsBuilder.reflectionEquals(expected, oslcIssue.getGitCmAuthor()));
  }
  ...
  public void checkGitLabTimeStats() {
    ...
    Assert.assertTrue(EqualsBuilder.reflectionEquals(expected, oslcIssue.getGitCmTimeStats()));
  }

  @Test
  public void checkDueDateIsUtc() {
    ZonedDateTime expected =
        ZonedDateTime.parse("2018-09-29T00:00:00Z", DateTimeFormatter.ISO_OFFSET_DATE_TIME);
  ...
  public void checkLinks() {
    ...
    Assert.assertTrue(EqualsBuilder.reflectionEquals(expected, oslcIssue.getGitCmLinks()));
  }
  ...
  public void checkWebUrl() {
    Assert.assertEquals(
        "https://git.lab/user.1/unit-test-project/issues/9", oslcIssue.getGitCmWebUrl());
  }
  ...
  public void checkClosedBy() {
    ...
    Assert.assertTrue(EqualsBuilder.reflectionEquals(expected, oslcIssue.getGitCmClosedBy()));
  }
  ...
  public void checkUtcDateTimeMapping() {
    ZonedDateTime created =
        ZonedDateTime.parse(
            "2018-03-13T15:24:48.339+01:00", DateTimeFormatter.ISO_OFFSET_DATE_TIME);

    ZonedDateTime modified =
        ZonedDateTime.parse(
            "2018-06-04T15:28:20.376+02:00", DateTimeFormatter.ISO_OFFSET_DATE_TIME);

    ZonedDateTime closed =
        ZonedDateTime.parse(
            "2018-06-08T15:28:20.376+02:00", DateTimeFormatter.ISO_OFFSET_DATE_TIME);
  ...
  public void makeIssue() throws IOException {
    ...
    this.oslcIssue =
        IssueMapper.map(
            issue, new URL("http://link-to-myself.ch"), "https://localhost:7443/jazz/web/");
  }
}
