...
public class MergeRequestMapper {
  ...
  public static OslcMergeRequest map(MergeRequest request, URL self, String baseUrl)
    ...
    final GitCmAssignee_ assignee =
        TypeConverter.<Assignee, GitCmAssignee_>convert(
            request.getAssignee(), GitCmAssignee_.class);
    ...
    mapper.addMappings(
        new PropertyMap<MergeRequest, OslcMergeRequest>() {
          @Override
